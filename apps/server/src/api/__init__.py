...
from src.api.feishu_task_api import router as feishu_task_router
...
from src.api.mock_workbench_api import router as mock_workbench_router

api_router = APIRouter()
api_router.include_router(workspace_router)
api_router.include_router(employee_router)
api_router.include_router(feishu_router)
api_router.include_router(feishu_task_router)
...
api_router.include_router(mock_workbench_router)
