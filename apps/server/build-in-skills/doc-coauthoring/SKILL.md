...
description: 撰写技术方案、标书 / 投标书、可行性报告、白皮书、需求文档、调研报告、长报告等较长正式文档的三步协作流程（澄清需求 → 大纲方案确认 → 分章写作）。当用户要写技术方案、标书、投标书、可行性报告、白皮书、长报告、需求文档、调研报告等长文档，或需要分章节、要审大纲、按模板正式成文时使用。
---
...
- **禁止**在聊天正文粘贴完整章节内容
- **禁止**在聊天正文写出 `/artifacts/...` 等虚拟路径；交付时只说文档名称，用户从变更卡片或产物面板打开
...
2. 自测：每个问题能否从文档中找到答案？
3. 修复 gap → `edit_file`
4. 用自然语言告知交付物名称，引导用户在工作台产物中打开（正文不写虚拟路径）
