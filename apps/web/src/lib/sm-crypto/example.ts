import { generateKeyPairHex, doEncrypt, doDecrypt, doSignature, doVerifySignature } from './'
...
// 验签
const verifyResult = doVerifySignature(msg, signature, keypair.publicKey, { hash: true })
