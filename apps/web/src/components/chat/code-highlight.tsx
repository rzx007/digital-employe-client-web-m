...
export function detectLanguage(filePath: string | undefined | null): string | undefined {
...
export function CodeHighlight({ code, language, className }: CodeHighlightProps) {
  ...
  return (
    <pre
      className={cn("m-0 p-2.5 font-mono text-xs text-muted-foreground/70 whitespace-pre-wrap", className)}
    >
      {code}
    </pre>
  )
