...
function calculateScoreFromClick(score: number, starIndex: number, clickPosition: "left" | "right") {
...
export function StarRating({
  ...
  const handleClick = React.useCallback(
    (starIndex: number, e: React.MouseEvent<SVGSVGElement>) => {
      ...
      const newScore = calculateScoreFromClick(value, starIndex, isLeft ? "left" : "right")
