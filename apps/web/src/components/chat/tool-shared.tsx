...
export function getDisplayContent(input: unknown, toolName: string): string | null {
...
export function getEditDiff(input: unknown): { oldCode: string; newCode: string } | null {
  if (!input || typeof input !== "object") return null
  const obj = input as Record<string, unknown>
...
export function getTodos(input: unknown, resultText: string | null | undefined): TodoItem[] | null {
